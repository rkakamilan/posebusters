...
def test_bust_redocks_1ia1() -> None:
    posebusters = ParallelPoseBusters("redock")
...
def test_bust_mol_rdkit() -> None:
    posebusters = ParallelPoseBusters(config="mol")
    mol = MolFromSmiles("C")
...
def test_bust_gen() -> None:
    posebusters = ParallelPoseBusters("gen")
...
def test_bust_loaded_mols() -> None:
    posebuster = ParallelPoseBusters("redock")
...
def test_check_energy_ratio_14gs_0(mol_pred_14gs_gen0):
    posebuster = ParallelPoseBusters("mol")
